...
// import Header from '../admin/adminHead'



async function deleteUser(id){
    // alert(id)
  await axios.post(`http://localhost:4000/admin/deleteUser/${id}`)
}
...
function AdminHome() {
  ...
  const fetchUsers = async () => {
    const { data } = await axios.get("http://localhost:4000/admin/getUser")
    setUser(data)
  }
